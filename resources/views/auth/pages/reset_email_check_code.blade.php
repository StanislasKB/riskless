        ...
        <div class="authentication-forgot d-flex align-items-center justify-content-center">
            <div class="card shadow-lg forgot-box">
                <div class="card-body p-md-5">
                    ...
                    <h4 class="mt-5 font-weight-bold">Entrez le code de validation</h4>
                    ...
                    @endforeach
                    <form action="{{ route('global.email_change_check.post') }}" method="post">
                        @csrf
                        <div class="mb-3 mt-4">
                    ...
                    <div class="mt-3 d-flex justify-content-start align-items-end">
                        ...
                        <a href="{{ route('global.email_change_resend_code.view') }}" class="link-primary ms-2">Renvoyer le
                            code</a>
                    </div>
