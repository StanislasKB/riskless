        ...
        <div class="authentication-forgot d-flex align-items-center justify-content-center">
            <div class="card shadow-lg forgot-box">
                <div class="card-body p-md-5">
                    ...
                    <h4 class="mt-5 font-weight-bold">Entrez le code de vérification</h4>
                    ...
                    @enderror
                    <form action="{{ route('auth.confirm_mail.post') }}" method="POST">
                        @csrf
                    ...
                    <div class="mt-3 d-flex justify-content-start align-items-end">
                        ...
                        <a href="{{ route('auth.resend_code', ['email' => request('email')]) }}"
