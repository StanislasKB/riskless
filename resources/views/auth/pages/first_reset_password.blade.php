                        ...
                        <div class="row g-0">
                            <div class="col-lg-5">
                                <div class="card-body p-md-5">
                                    ...
                                    <p class="text-muted">Vous devez réintialiser votre mot de passe dès votre première connexion !</p>
                                    <form action="{{ route('auth.first_reset_password.post') }}" method="post">
                                        @csrf
                                        <div class="mb-3 mt-5">
