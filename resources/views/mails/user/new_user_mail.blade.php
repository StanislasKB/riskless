...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Nous vous informons que vous avez été ajouté sur {{ config('app.name') }} en tant que {{ $type }} par {{ $added_by }}. Nous sommes ravis de vous compter parmi nos utilisateurs.</p>
            
            <p>Voici votre mot de passe:</p>
            <a class="button">{{ $password }}</a>
            
            <p>Vous serez amené à changer ce mot de passe dès votre première connexion.</p>
