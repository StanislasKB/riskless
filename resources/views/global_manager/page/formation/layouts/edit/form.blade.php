        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('global.formation.update.post',['id'=>$formation->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Titre</label>
                            <input type="text" class="form-control" id="validationCustom01" name="title" value="{{ $formation->title }}"  required >
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="validationCustom04" name="visibility" required>
                                ...
                                <option value="ALL" @if ($formation->visibility=='ALL')  selected @endif>Tout le monde</option>
                                <option value="ONLY_MEMBERS" @if ($formation->visibility=='ONLY_MEMBERS')  selected @endif>Collègues uniquement</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="validationCustom04" name="status" required>
                                ...
                                <option value="ACTIVE" @if ($formation->status=='ACTIVE')  selected @endif>Actif</option>
                                <option value="INACTIVE" @if ($formation->status=='INACTIVE')  selected @endif>Inactif</option>
                            </select>
                        </div>
                         <div class="col-md-12">
                            <label for="validationCustom006" class="form-label">Courte description (50 mots max)</label>
                            <textarea class="form-control" name="description" id="validationCustom006" required cols="30" rows="5">{{ $formation->description }}</textarea>
                        </div>
                        <div class="col-md-6">
